...
Bytes AESWrapper::GenerateKey()
{
    unsigned char buffer[DEFAULT_KEYLENGTH];
    AESWrapper::GenerateKey(buffer, DEFAULT_KEYLENGTH);
    return Bytes(buffer, buffer+DEFAULT_KEYLENGTH);
}
